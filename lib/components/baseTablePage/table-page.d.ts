...
import { InputProps, TextAreaProps } from 'ant-design-vue/es/input';
import { InputNumberProps } from 'ant-design-vue/es/input-number';
import { SelectProps } from 'ant-design-vue/es/select';
import { SwitchProps } from 'ant-design-vue/es/switch';
export type FieldType = 'number' | 'string' | 'datapicker' | 'rangepicker' | 'select' | 'treeselect';
interface BaseField {
    type: FieldType;
    label: string;
    name: string;
